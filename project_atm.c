...
int food(){
    int foodChoice;
    struct foods_stock fst[size] = {{45, "Pork Fried Rice"}, {55, "Shrimp Fried Rice"}, {69, "Rice with Red Curry"}, {45, "Minced Pork Pad Ka Prao with Fried Egg"}, {40, "Minced Pork Pad Ka Prao"}, {35, "Smoky flavour pork sausage"}, };
    for(i=0;i<size;i++){
